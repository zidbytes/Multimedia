...
class AppRPPG(tk.Tk):
    def __init__(self, master=None):
        ...
        self.title("VitalCam - Real-Time rPPG Monitoring")
    ...
    def _setup_plots(self):
        if MATPLOTLIB_AVAILABLE:
            ...
            self.ax_rppg.set_title("Sinyal rPPG Real-Time", fontsize=10)
            ...
            self.peaks_rppg_line_plot, = self.ax_rppg.plot(
                [], [], 'bo', markersize=3)
            self.ax_rppg.set_ylim(-15, 15)
            self.ax_rppg.set_xlim(0, 250)
            self.ax_rppg.grid(True, alpha=0.3)
    ...
    def create_widgets(self):
        ...
        main_content_frame.columnconfigure(
            0, weight=1, minsize=400, uniform="app_cols")
        main_content_frame.columnconfigure(
            1, weight=1, minsize=400, uniform="app_cols")
        main_content_frame.rowconfigure(
            0, weight=2, minsize=400, uniform="app_rows_main")
        ...
        rppg_plot_area.grid(row=0, column=0, sticky="nsew", padx=5, pady=5)
        ...
        self.webcam_label = tk.Label(
            webcam_frame_container, bg="black", text="Kamera Tidak Aktif", fg="white", font=("Arial", 12))
        ...
        numeric_data_area = ttk.LabelFrame(
            right_column_frame, text=" Heart Rate Data ")
        ...
        tk.Label(numeric_data_area, text="Heart Rate (rPPG)", font=(
            "Arial", 12, "bold"), fg="red").grid(row=0, column=0, sticky="s", pady=(5, 0))
        self.lbl_hr_value = tk.Label(
            numeric_data_area, text="--", font=("Arial", 42, "bold"), fg="red")
        self.lbl_hr_value.grid(row=1, column=0, sticky="nsew")
        tk.Label(numeric_data_area, text="BPM", font=("Arial", 12),
                 fg="red").grid(row=2, column=0, sticky="n", pady=(0, 5))
    ...
    def stop_webcam_feed(self):
        ...
        self.webcam_label.config(image="", text="Kamera Tidak Aktif")
        ...
        if ret:
            ...
            if self.rppg_proc:
                try:
                    ...
                    # Menggunakan method dari rppg_processor.py
